...
public class ChatServer {
    ...
    private static HashMap<String,PrintWriter> nameWithWritters = new HashMap<String,PrintWriter>();
    ...
    private static class Handler implements Runnable {
        ...
        public void run() {
            ...
            for(String key : nameWithWritters.keySet()) {
            	if(key.equals(name)) {
            		for(String name : names) {
            			nameWithWritters.get(key).println("NEWNAME"+name);
            		}
            	}else {
            		nameWithWritters.get(key).println("NAME"+name);
            	}
            }
                ...
                while (true) {
                    ...
                    for(String n:passednames){
                    	for(String key :nameWithWritters.keySet()) {
                    		if(n.equals(key)){
                    			nameWithWritters.get(key).println("message"+ name + ":"+input.substring(3));
